...
const Todos = ({todoText}) => {
    ...
    return (
        <div 
          ...
          items-center py-4 bg-gray-300 rounded-xl mb-2"
        ...
        >
          ...
          {isHovered && (
            <div className="buttons absolute right-0 flex items-center pr-2">
              <Button className='mr-1 hover:bg-green-400 border-0' variant="outline" size="icon">
                <CheckCheck className="h-4 w-4" />
              </Button>
              <Button className='bg-rose-600 border-0 text-white' variant="outline" size="icon">
                <X className="h-4 w-4" />
              </Button>
            </div>
          )}
